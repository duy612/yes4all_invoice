...
fcr_file = (r'C:\Users\duyduong\Desktop\Minh Duy\1. Work\2. Task\2. LSQ\2-WK\3-WK NOT YET UPLOADED\Po_extracted_file\13-po_extracted_11242022.xlsx')
...
with left_column:
    st.subheader(f"Invoice Count: {total_invoice}")
    # st.subheader(total_invoice)
with right_column:
    st.subheader(f"Amount: US${total_amount:,}")
